...
<div class="cart_totals <?php echo (WC()->customer->has_calculated_shipping()) ? 'calculated_shipping' : ''; ?>">
  ...
  <div class="carttotal">
    <h2 class="title"><?php _e('Total'); ?></h2>
    ...
    <div cellspacing="0" class="shop_table shop_table_responsive">
      ...
      <div class="carttotal__price">
        <div class="order-total flalign">

          <p><?php echo WC()->cart->get_cart_contents_count(); ?> <?php _e(' item for the total price:'); ?></p>
          <span data-title="<?php esc_attr_e('Total', 'woocommerce'); ?>"> <text><?php wc_cart_totals_order_total_html(); ?></text></span>
        </div>
